 ...
 */
public class SHttpConnection extends HttpResourceConnection
{
     ...
     *
     * @throws ProtocolNotSuppException if the protocol is not supported
     */
    public SHttpConnection(String host, int port, String path)
        throws MalformedURLException
    {
        super(new URL(URI.SHTTP_SCHEME, host, port, path));
        ...
        if(current_connection == null)
        {
            ...
            try
            {
                current_connection = new HTTPConnection(URI.SHTTP_SCHEME, host, port);
...
//      current_connection.setAllowUserInteraction(allowUserInteraction);
    ...
    public String getHeaderField(String name)
    {
        ...
        try
        {
            ...
            ret_val = response.getHeader(name);
        }
        catch(Exception e)
        {
        }
    ...
    private void parseHeaders()
    {
        ...
        try
        {
            ...
            header_map.put(header_keys.get(0), header_zero.toString());
        }
        catch(Exception e)
        {
