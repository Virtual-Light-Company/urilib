 ...
 * <P>
 *
 * An resource usually represents a particular distinguished name or the
 * attribute value of the system. The current implementation does not know
 * how to deal with an attribute lookup :(
 * <P>
 *
 * <P>
 *
...
public class LDAPResourceConnection extends ResourceConnection
{
  ...
  {
    super(new URL(UIRConstants.LDAP_SCHEME, host, port,  path));
    ...
    env.put(Content.INITIAL_PROVIDER_URL, "ldap://" + host + ':' + real_port);
