...
class FileParser
{
  ...
  /**
   * Parse the contents of the file and return a collection of namespace
   * resolvers that do the job.
   *
   * @param is The stream providing the raw bytes
   * @return A list of the namespace resolvers found
   * @exception IOException An error occurred parsing the file
   * @throws ConfigErrorException There was a syntax problem somewhere in
   *    the file, probably in the Regexp areas. 
   */
  ...
  /**
   * Parse the bindings file that is available on the nominated
   * reader.
   *
  ...
  /**
   * Check to see if the given string is the same as one of the keywords.
   * If so, return true.
   *
  ...
  /**
   * Clear the tokenizer until we come to the next NID keyword or end of
   * file.
   *
  ...
  /**
   * Clear the tokenizer until we come to the next NID, GROUP keyword or end
   * of file.
   *
   * @param strtok The stream tokenizer instance to clear
   */
  ...
  /**
   * Clear the tokenizer until we come to the next NID, GROUP or RES
