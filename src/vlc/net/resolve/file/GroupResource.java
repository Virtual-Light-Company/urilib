 ...
 * <P>
 *
 * The holder class does all the manipulation required for each group.
 * On setup, it does validity checking of all data. On query, it generates
 * the completed URLs as required.
 * <P>
 *
...
//    System.out.println("  regex: " + regex);
  ...
  /**
   * Fetch just a single version of the resource. This takes the resource from
   * the top of the list, generates the appropriate fully qualified URL and
   * returns that value.
   *
   * @param urn The urn that we need to rip apart
   * @return The fully qualified URL matching this URN.
   * @exception MalformedURLException An erroroneous URL was created
   */
  ...
  /**
   * Fetch all the resources that have been generated for this URN. This takes
   * all of the set resources and generates complete URLs for them.
   *
   * @param urn The urn that we need to rip apart
