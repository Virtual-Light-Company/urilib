...
{
  /**
   * Constructs a <code>NoURNConfigException</code> with no detail message.
   */
  ...
  /**
   * Constructs a <code>NoURNConfigException</code> with the
   * specified detail message.
   *
   * @param msg the detail message.
   */
  public NoURNConfigException(String msg)
  {
      super(msg);
  }
}