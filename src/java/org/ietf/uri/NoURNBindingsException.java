...
/**
 * Thrown to indicate that the file describing the URNBindings could not be
 * located on the system according the prescribed rules.
 * <P>
 *
...
{
    /**
     * Constructs a <code>NoURNBindingsException</code> with no detail message.
     */
    ...
    /**
     * Constructs a <code>NoURNBindingsException</code> with the
     * specified detail message.
     *
     * @param   msg   the detail message.
     */
    public NoURNBindingsException(String msg)
    {
        super(msg);
    }
}