 ...
 * type <CODE>ldap:</CODE> that contains inlined data information.
 * <P>
 *
 * A ldap protocol handler is of the format:
 * <PRE>
 *   ldap://host[:port]/[distinguished name]
 * </PRE>
 * 
 * The present implementation uses what seems to be logical rather than based
 * on any particular set standard (Couldn't find one).
 * <P>
 *
 * If the media type is known then the appropriate content handler is fetched
 * and used to intepret the stream from the LDAPResourceConnection.
 * <P>
 *
